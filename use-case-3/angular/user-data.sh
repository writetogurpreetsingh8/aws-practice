...
sudo mkdir -p /home/ec2-user/angular
sudo chown -R ec2-user:ec2-user /home/ec2-user/angular
cd /home/ec2-user/angular
...
sudo docker pull 539247483490.dkr.ecr."$REGION".amazonaws.com/easy-task-repo:node

echo "fetching jre image from aws ecr"
sudo docker pull 539247483490.dkr.ecr."$REGION".amazonaws.com/easy-task-repo:nginx-alpine

echo "building image from dockerfile..."
sudo docker build -t web-app:latest .
sudo docker tag web-app:latest 539247483490.dkr.ecr."$REGION".amazonaws.com/easy-task-repo:web-app
sudo docker push 539247483490.dkr.ecr."$REGION".amazonaws.com/easy-task-repo:web-app

echdo "exeuting docker image to make docker process"

docker run -d -p 80:8080 539247483490.dkr.ecr."$REGION".amazonaws.com/easy-task-repo:web-app