...
public class CognitoController {
 ...
 // 2) callback handler stays the same
	...
	/*
	 * @GetMapping("/me") public Map<String, Object> user(Authentication
	 * authentication) { OAuth2AuthenticationToken oauthToken =
	 * (OAuth2AuthenticationToken) authentication; OidcUser oidcUser = (OidcUser)
	 * oauthToken.getPrincipal(); return Map.of( "email", oidcUser.getEmail() ); }
	 */
